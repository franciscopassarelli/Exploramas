...
import DesktopCarousel from './DesktopCarousel';  // Importamos el componente para desktop
import MobileCarousel from './MobileCarousel';    // Importamos el componente para responsive
...
<div className="relative w-full h-[400px] mb-12">
      ...
      <div className="container mx-auto px-4 py-8 flex-grow">
        ...
        {/* Renderizar el componente correspondiente según el tamaño de la pantalla */}
        {isMobile ? (
          <MobileCarousel
      ...
      {/* Modal de Detalle del Paquete Seleccionado */}
      {selectedPackage && (
        <PackageModal
